export default class PromptTracker {
  ...
  exportFullDataset() {
    ...
    const fullData = {
      metadata: {
        ...
        gameVersion: '1.0',
        characterCount: this.gameState.characters.length,
      ...
      gameConfig: {
        ...
        promptCap: this.gameState.promptCap,
        apiProvider: this.gameState.apiProvider
      },
